...
I avoid using javascript as much as possible. That's why I only have javascript [[https://ismailefe.org/analog_photos/][on my Photos Page]], which only adds the ability to expand the photos. The site works perfectly fine without it.
